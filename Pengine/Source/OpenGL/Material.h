...
namespace Pengine
{
	...
	class PENGINE_API Material : public IAsset
	{
		...
		private: PROPERTY(Material, std::string, m_NormalMapFilePath, "White")
		...
		public: PROPERTY(Material, bool, m_UseNormalMap, false)
	private:
	...
	public:
		...
		void SetNormalMap(class Texture* texture, const std::string& filePath);
	};
